...
// paymastercoin: total coins staked (non-spendable until maturity)
...
// paymastercoin: get current stake weight
...
// paymastercoin: check 'spent' consistency between wallet and txindex
// paymastercoin: fix wallet spent state according to txindex
...
// paymastercoin: disable transaction (only for coinstake)
